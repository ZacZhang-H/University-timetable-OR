        ...
        for day in range(1, weekdays_num + 1):
            ...
            for room in rooms:
                ...
                for start_hour in range(1, max_lecture_hours - hours_needed + 1):
                    ...
                    if day == 3 and (end_hour > 4 and start_hour < 10):
                        continue  
                    if end_hour <= max_lecture_hours and is_time_slot_available(timetable, room, day, start_hour, end_hour):
    ...
    for course in courses_to_mutate:
        ...
        for _ in range(100):  
            ...
            if room_capacities[room] >= students_per_course[course]:
                ...
                if day == 3 and (end > 4 and start < 10):
                    continue  
...
def simulated_annealing_Wednesday(timetable, courses, hours_per_course, students_per_course, room_capacities, rooms, weekdays_num, max_lecture_hours, max_iterations=100000):
